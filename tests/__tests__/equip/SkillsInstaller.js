  ...
  describe('constructor', () => {
    describe('should keep property', () => {
      ...
      describe('#domainFilter', () => {
        ...
        test.each(cases)('domains: $input.domainFilter.domains', ({ input }) => {
          const args = {
            sourceDirectoryPath: '',
            targetDirectoryPath: '',
          ...
          expect(installer)
            .toHaveProperty('domainFilter', input.domainFilter)
        })
      })
        ...
        const cases = [
          {
            input: {
              manifestFile: SkillsManifestFile.create({
                filePath: '/consumer/.hora/equip-skills.json',
          ...
          },
          {
            input: {
              manifestFile: SkillsManifestFile.create({
                filePath: '.hora/equip-skills.json',
    ...
    describe('should call constructor', () => {
      const cases = [
        ...
        },
        {
          ...
          expected: {
            filePath: '/tmp/.hora/equip-skills.json',
    ...
    describe('should place the manifest under the working directory', () => {
      const cases = [
        ...
        },
        {
          ...
          expected: '/tmp/.hora/equip-skills.json',
        },
      ]
  ...
  describe('#install()', () => {
    describe('should record what it installed', () => {
      ...
      test.each(cases)('installedSkillNames: $override.installedSkillNames', ({ override, expected }) => {
        ...
        jest.spyOn(installer, 'copySelectedSkills')
...
describe('SkillsInstaller', () => {
  describe('#copySelectedSkills()', () => {
    describe('should copy each selected skill into the target directory', () => {
      const cases = [
        {
          override: {
            selectedSkillNames: [
      ...
      test.each(cases)('selectedSkillNames: $override.selectedSkillNames', ({ override, expected }) => {
        ...
        jest.spyOn(installer, 'selectSkillNames')
...
describe('SkillsInstaller', () => {
  describe('#selectSkillNames()', () => {
    describe('should be the distributed skills of the selected domains', () => {
      const cases = [
        {
          input: {
            domains: [
      ...
      test.each(cases)('domains: $input.domains', ({ input, expected }) => {
        const installer = SkillsInstaller.create({
          workingDirectoryPath: '/consumer',
          targetDirectoryPath: '/consumer/.claude/skills',
          domainFilter: SkillDomainFilter.create(input),
          sourceDirectoryPath: '/package/dist/skills',
        })
        ...
        const received = installer.selectSkillNames()
...
describe('SkillsInstaller', () => {
  describe('#saveManifest()', () => {
    describe('should record the version, the domains and the skills', () => {
      const cases = [
        {
          override: {
            version: '0.0.1',
