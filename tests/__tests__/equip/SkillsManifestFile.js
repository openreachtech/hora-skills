        ...
        const cases = [
          {
            ...
            expected: '/tmp/app/.hora/equip-skills.json',
          },
          {
            input: {
            ...
            expected: '.hora/equip-skills.json',
          },
        ]
  ...
  describe('#load()', () => {
    describe('should parse the manifest', () => {
      const cases = [
        {
          override: {
            content: '{"version":"0.0.1","installations":{".claude/skills":{"domains":["backend"],"skillNames":["hb-query-resolver"]}}}',
          },
          expected: {
            version: '0.0.1',
            installations: {
      ...
      const cases = [
        {
          ...
          expected: [
            '/tmp/app/.hora/equip-skills.json',
            '{\n  "version": "0.0.1",\n  "installations": {\n    ".claude/skills": {\n      "domains": [\n        "backend"\n      ],\n      "skillNames": [\n        "hb-query-resolver"\n      ]\n    }\n  }\n}\n',
          ],
        },
        {
