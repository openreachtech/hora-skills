...
- For members without `@public` where it is unclear whether they are called from outside, do not decide unilaterally — confirm with the user whether they should be listed in the API section.
