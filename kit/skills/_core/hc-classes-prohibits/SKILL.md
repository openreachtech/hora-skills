...
- If multiple classes use it and they belong to the same inheritance hierarchy, place the shared implementation in the base class. Expressing it through inheritance makes the locus of responsibility clearer.
