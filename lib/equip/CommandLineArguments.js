/**
 * The arguments given to the `hora-skills` command.
 *
...
export default class CommandLineArguments {
  ...
  /**
   * Extract the domains given by `--domains`.
   *
   * @returns {Array<string> | null} Domain names, or null when the option was not given.
   * @public
   */
  extractDomains () {
    const value = this.extractOptionValue({
      name: 'domains',
    })
